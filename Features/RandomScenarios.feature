...
Then User enter into textbox "lastName" "Sing"
Then User Click on "saveAll"
Then Switch to Frame defaultcontent
Then User Verify the text "userMenuDropDown" "Geethanjali Sing"
...
When User enter into textbox "password" "Narayana7"
Then User Click on "Login"
Then User is on "RandomScenariosPage"
Then User Click on "allTabsArrow"
Then User Click on "customizeTabs"
Then User Verify the text not in DropDown "selectedTabs" "Contacts"
